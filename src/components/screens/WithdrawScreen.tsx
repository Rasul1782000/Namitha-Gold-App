...
export const WithdrawScreen = ({ setScreen }: { setScreen: (s: Screen) => void }) => {
  return (
    <div className="h-full bg-bg text-white p-6 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-2xl font-display font-bold mb-4">Withdraw</h2>
        <p className="text-text-muted">Withdraw your funds securely.</p>
      </div>
    </div>
  );
};
